...
import findRoute, {
  getUrlQuery,
} from 'C:/Users/DELL/Desktop/MyProject/EnvironmentalMgrB/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: 'C:/Users/DELL/Desktop/MyProject/EnvironmentalMgrB',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
